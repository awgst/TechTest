...
--
-- Host: localhost:3306
-- Generation Time: Aug 27, 2021 at 03:24 AM
...
--
ALTER TABLE `tb_mahasiswa_nilai`
  ADD CONSTRAINT `fk_mhs_id` FOREIGN KEY (`mhs_id`) REFERENCES `tb_mahasiswa` (`mhs_id`),
  ADD CONSTRAINT `fk_mk_id` FOREIGN KEY (`mk_id`) REFERENCES `tb_matakuliah` (`mk_id`);
COMMIT;
